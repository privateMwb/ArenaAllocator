...
// converts snake_case names to Title Case for display
...
// returns a colored duration string based on elapsed time
...
// returns a colored iteration count based on benchmark size
...
// shared callable for benchmarking allocations of a common struct
struct Item {
    int    id_;
    float  value_;
    double weight_;

    Item(int id, float value, double weight)
