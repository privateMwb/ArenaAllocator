...
static void concurrent_reads_consistent_values() {
...
static void concurrent_view_calls_consistent() {
    Arena<> arena(256);
...
static void run_tests() {
    RUN(concurrent_reads_consistent_values);
    RUN(concurrent_view_calls_consistent);
}
