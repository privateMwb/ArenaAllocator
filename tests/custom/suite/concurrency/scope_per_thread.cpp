...
static void independent_arenas_no_interfere() {
...
static void each_thread_independent_capacity() {
    constexpr int kThreads = 8;
    std::atomic<bool> allConsistent{true};
...
static void run_tests() {
    RUN(independent_arenas_no_interfere);
    RUN(each_thread_independent_capacity);
}
